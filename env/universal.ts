...
if (typeof window === "undefined") {
  ...
  console.log("🔧 env/universal.ts 환경 변수 로드 상태:", {
    ...
    hasSupabaseUrl: !!envConfig.supabaseUrl,
    hasSupabaseServiceRoleKey: !!envConfig.supabaseServiceRoleKey,
    supabaseUrlLength: envConfig.supabaseUrl?.length || 0,
    supabaseKeyLength: envConfig.supabaseServiceRoleKey?.length || 0,
